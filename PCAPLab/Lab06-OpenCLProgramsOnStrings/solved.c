...
int main(void) {
    ...
    cl_kernel kernel = clCreateKernel(program, "vector_toggle_case", &ret);
    ...
    char * str_res= (char *) malloc(sizeof(char) * len);
    
    ret = clEnqueueReadBuffer(command_queue, t_mem_obj, CL_TRUE, 0, len * sizeof(char), str_res, 0, NULL, NULL);
